      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="text-center">
            ...
            <h5 class="mb-3">¿Está seguro que desea deshabilitar esta asignación?</h5>
            <p class="text-muted">Esta acción cambiará el estado de la asignación médico-especialidad a "Inactivo". Podrá habilitarla nuevamente si es necesario.</p>
          </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
          <button type="button" class="btn btn-danger" onclick="deshabilitarMedicoEspecialidad()">Deshabilitar</button>
        </div>
      </div>
    </div>
  </div>
